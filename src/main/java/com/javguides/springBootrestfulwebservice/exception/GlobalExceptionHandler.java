package com.javguides.springBootrestfulwebservice.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    // client wants error in this format
    ...
    private ResponseEntity<ErrorDetails> handleEmailAlreadyExistsException(EmailAlreadyExistsException emailAlreadyExistsException,
                                                                           WebRequest webRequest){
        ErrorDetails errorDetails=new ErrorDetails(
                LocalDateTime.now(),
